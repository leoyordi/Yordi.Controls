 ...
 * 1.0.0.5 (13 mar 2024): Added ToGrayScale
 * Issues addressed
 * ----------------
...
namespace Yordi.Controls
{
	public static class GraphicsExtension
	{
        ...
        public static Color ChangeAlpha(this Color originalColor, byte newAlpha)
        {
            if (originalColor.Equals(Color.Transparent) || newAlpha == originalColor.A)
                return originalColor;
