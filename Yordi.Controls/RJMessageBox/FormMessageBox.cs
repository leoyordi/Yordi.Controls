    ...
    private void SetIcon(MessageBoxIcon icon)
    {
        switch (icon)
        {
            case MessageBoxIcon.Error: //Error
                this.pictureBoxIcon.Image = Yordi.Controls.Properties.Resources.Error;
            ...
            case MessageBoxIcon.Information: //Information
                this.pictureBoxIcon.Image = Yordi.Controls.Properties.Resources.Info;
                PrimaryColor = Color.FromArgb(38, 191, 166);
                break;
            case MessageBoxIcon.Question://Question
                this.pictureBoxIcon.Image = Yordi.Controls.Properties.Resources.Warning;
